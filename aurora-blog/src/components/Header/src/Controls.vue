<template>
      ...
      <Dropdown hover>
        ...
        <DropdownMenu>
          <template v-if="!isMobile">
            ...
            <DropdownItem @click="openForgetPasswordDialog">Edit Password</DropdownItem>
          </template>
  ...
  <el-dialog title = 'Edit Password' v-model="forgetPasswordDialogVisible" width="30%" :fullscreen="isMobile">
    <el-form>
      <el-form-item model="userInfo" type="password" class="mt-8">
        Old Password:
        <el-input v-model="loginInfo.oldPassword" type="password" show-password placeholder="Old Password" />
      </el-form-item>
      <el-form-item model="userInfo" type="password" class="mt-8">
        New Password:
        <el-input v-model="loginInfo.password" type="password" show-password placeholder="New Password" />
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="updatePassword" size="large" class="mx-auto mt-3">SUBMIT</el-button>
      </el-form-item>
    </el-form>
  </el-dialog>
  <!--  <teleport to="body">
