  ...
  <div class="article-container">
    ...
    <div class="feature-article">
      <div class="feature-thumbnail">
        <img v-if="article.memoryCover" class="ob-hz-thumbnail" v-lazy="article.memoryCover" />
      ...
      <div class="feature-content">
        ...
        <h1 class="article-title" v-if="article.memoryTitle" @click="toArticle" data-dia="article-link">
          <a>
            <span>{{ article.memoryTitle }}</span>
            <svg-icon v-if="article.status == 2" icon-class="lock" class="lock-svg" />
          </a>
        </h1>
        <ob-skeleton v-else tag="h1" height="3rem" />
        <p v-if="article.memoryContent">{{ article.memoryContent }}</p>
