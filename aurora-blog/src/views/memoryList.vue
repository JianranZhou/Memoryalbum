<template>
  <div>
    <div class="post-header" style="font-size: 22px;">
      ...
      <h1 class="post-title text-white uppercase">memory list</h1>
    </div>
    ...
    <div style="padding: 30px;background-color: #fff;border-radius: 30px;">
      ...
      <div style="display: flex;margin-top: 30px;flex-wrap: wrap;justify-content: space-between;">
        <div v-for="(item, index) in articles" :key="index"
          ...
          <img style="width: 100%;height: 40%;" v-if='item.memoryCover' :src="item.memoryCover" alt="">
          <img style="width: 100%;height: 40%;" v-else src="@/assets/default-cover.jpg" alt="">
