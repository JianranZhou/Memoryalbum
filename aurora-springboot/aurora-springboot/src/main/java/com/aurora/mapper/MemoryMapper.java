...
public interface MemoryMapper extends BaseMapper<Memory> {
    ...
    List<MemoryCardDTO> listArticles(@Param("current") Long current, @Param("size") Long size, @Param("keywords") String keywords, @Param("userId") Integer userId);
    ...
    List<MemoryCardDTO> listArticlesByTagId(@Param("current") Long current, @Param("size") Long size, @Param("tagId") Integer tagId, @Param("userId") Integer userId);

    List<MemoryCardDTO> listArchives(@Param("current") Long current, @Param("size") Long size, @Param("userId") Integer userId);

    Integer countArticleAdmins(@Param("conditionVO") ConditionVO conditionVO);

    List<MemoryAdminDTO> listArticlesAdmin(@Param("current") Long current, @Param("size") Long size, @Param("conditionVO") ConditionVO conditionVO);
